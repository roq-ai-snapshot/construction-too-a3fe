  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental v1 - Your one-stop destination for renting construction tools from a wide network of outlets. Simplifying construction, one tool at a time."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Construction Tool Rental v1 - Your one-stop destination for renting construction tools from a wide network of outlets. Simplifying construction, one tool at a time.`}
            </Text>
            <Box
