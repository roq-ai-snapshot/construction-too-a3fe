...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'Product.create': { roles: ['tenant-roles'], key: 'product_123', tenantPath: [], userPath: [] },
  'Return.create': { roles: ['tenant-roles', 'tenant-owner-roles'], key: 'return_123', tenantPath: [], userPath: [] },
};
